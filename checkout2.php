...
if (!isset($_SESSION["username"])) {
    ...
    exit(); // Always good to add exit after header redirect
}
 $host="localhost";
 $user="root";
 $password="";
...
$sql = "Select * from checkout where Email = '$a'";
...
SET ReceiverName='$name', Surname='$surname', `Street Address`='$streetadress', Complex='$complexbuilding', 
Surburb='$suburb', City='$citytown', CellPhone='$cellphonenumber', Province='$province', 
postalCode='$postalcode' 
WHERE Email='$a' AND UserID='$session'";
...
echo ' <a  id="cancelling" class="cancel" href="cancel.php" name="cancel">Cancel Checkout</a>';
 }
...
if (mysqli_num_rows($run_query) ==1) 
{
  ...
  <h1> Edit Recipient Delivery Information</h1>
  
   
  <input type="text" name="nname" class="what" placeholder="Receiver Name" value="' . htmlspecialchars($row["ReceiverName"]) . '">
  <br>
  <span class="error">' . $nameerror . '</span><br>
  
  <input type="text" name="surname" class="what" placeholder="Receiver Surname" value="' . htmlspecialchars($row["Surname"]) . '">
  <br>
  <span class="error">' . $surnameerror . '</span><br>
  
  <input type="text" name="streetaddress" class="what" placeholder="Street Address" value="' . htmlspecialchars($row["Street Address"]) . '">
  <br>
  <span class="error">' . $streetadresserror . '</span><br>

  <input type="text" name="complex_building" class="what" placeholder="Complex/Building" value="' . htmlspecialchars($row["Complex"]) . '">
  <br>
  <span class="error">' . $complexbuildingerror . '</span><br>

  <input type="text" name="suburb" class="what" placeholder="Suburb" value="' . htmlspecialchars($row["Surburb"]) . '">
  <br>
  <span class="error">' . $suburberror . '</span><br>

  <input type="text" name="citytown" class="what" placeholder="City/Town" value="' . htmlspecialchars($row["City"]) . '">
  <br>
  <span class="error">' . $citytownerror . '</span><br>

  <input type="text" name="cellphonenumber" class="what" placeholder="Cellphone" value="' . htmlspecialchars($row["CellPhone"]) . '">
  <br>
  <span class="error">' . $cellphoneerror . '</span><br>

  <input type="text" name="province" class="what" placeholder="Province" value="' . htmlspecialchars($row["Province"]) . '">
  <br>
  <span class="error">' . $provinceerror . '</span><br>

  <input type="text" name="postalcode" class="what" placeholder="Postal Code" value="' . htmlspecialchars($row["postalCode"]) . '">
  <br>
